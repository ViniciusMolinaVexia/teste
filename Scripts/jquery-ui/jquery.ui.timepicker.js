...
(function ($) {
    ...
    function Timepicker() {
        ...
        this.regional[''] = { // Default regional settings
            ...
            deselectButtonText: 'Remover'  // Text for the deselect button
        };
        ...
        this.tpDiv = $('<div id="' + this._mainDivId + '" class="ui-timepicker ui-widget-datepicker ui-helper-clearfix ui-corner-all-datepicker " style="display: none"></div>');
    }
    ...
    $.fn.timepicker = function (options) {
        ...
        if ($('#' + this._mainDivId).length == 0) $.timepicker.initialized = false;
        if (options != undefined && options.target != undefined)
            idPai = options.target;
        else
            idPai = '#' + this.closest("div").attr("id");
        
        /* Initialise the time picker. */
        if (!$.timepicker.initialized) {
            $(document).mousedown($.timepicker._checkExternalClick).
            find(idPai).append($.timepicker.tpDiv);
